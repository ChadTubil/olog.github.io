            ...
            <form  method="post" role="form" enctype="multipart/form-data">
                ...
                <div style="text-align: left;">
                    <p style="font-size: 20px; color: black;">
                        Your tuition fee is on checking and processing by our admin, wait for the confirmation email, text message or 
                        <a href="default.php">login</a> your credential to check the status of your application. Usually it takes
                        1 to 2 hours to process your application. Thank you!
                    </p>

                    <br>
                    <br>
                    <p style="font-size: 16px; color: black;">If you are an scholar or have an discount voucher. Contact us by sending an email here: admin@olog.com</p>
                    <br>
                    <br>
                    <br>
                    <hr>
