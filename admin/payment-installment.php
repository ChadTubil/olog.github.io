<?php
    ...
    if(isset($_POST['btnSubmitThird'])) {

        $date = date('Y-m-d');

        $sqlUpdateIns = "UPDATE installments_tbl SET ins_third_date = '$date' WHERE ins_cash_id = '$id'";
        mysqli_query($dbConString, $sqlUpdateIns);

        $sqlUpdate = "UPDATE cashier_tbl SET cash_status = '3rd Payment Paid' WHERE cash_id = '$id'";
        mysqli_query($dbConString, $sqlUpdate);
        ...
        if($fetchCheckPayment['cash_status'] == '3rd Payment Paid'){
            $sqlUpdateStudent = "UPDATE students_tbl SET stud_status = '3rd Payment Paid' WHERE stud_id = '$CStudId'";
            mysqli_query($dbConString, $sqlUpdateStudent);

            header("location: cashier.php");
        }else{
            $sqlUpdateStudent = "UPDATE students_tbl SET stud_status = '3rd Payment Refused' WHERE stud_id = '$CStudId'";
            mysqli_query($dbConString, $sqlUpdateStudent);
    ...
    if(isset($_POST['btnSubmitThird'])) {
        ...
        $sqlUpdateIns = "UPDATE installments_tbl SET ins_fourth_date = '$date' WHERE ins_cash_id = '$id'";
        mysqli_query($dbConString, $sqlUpdateIns);

        $sqlUpdate = "UPDATE cashier_tbl SET cash_status = '4th Payment Paid' WHERE cash_id = '$id'";
        mysqli_query($dbConString, $sqlUpdate);
        ...
        if($fetchCheckPayment['cash_status'] == '4th Payment Paid'){
            $sqlUpdateStudent = "UPDATE students_tbl SET stud_status = '4th Payment Paid' WHERE stud_id = '$CStudId'";
            mysqli_query($dbConString, $sqlUpdateStudent);

            header("location: cashier.php");
        }else{
            $sqlUpdateStudent = "UPDATE students_tbl SET stud_status = '4th Payment Refused' WHERE stud_id = '$CStudId'";
            mysqli_query($dbConString, $sqlUpdateStudent);
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4" style="text-align: center;">
                                                            ...
                                                            <button class="btn btn-success" 
                                                                <?php 
                                                                    if ($fetchIns["ins_third_image"] == ''){ ?> disabled <?php   } 
                                                                    if ($CSTAT == 'THIRD PAID'){ ?> hidden <?php   } 
                                                                ?> 
                                                            style="width: 100%;" name="btnSubmitThird">ACCEPT</button>
                                                        </div>
                                                        <div class="col-8" style="text-align: center;">
                                                            <img src="../image/<?php print $fetchIns["ins_third_image"]?>" style="width: 80%; height: 300px;">
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-4" style="text-align: center;">
                                                            ...
                                                            <button class="btn btn-success" 
                                                                <?php 
                                                                    if ($fetchIns["ins_fourth_image"] == ''){ ?> disabled <?php   } 
                                                                    if ($CSTAT == 'FOURTH PAID'){ ?> hidden <?php   } 
                                                                ?> 
                                                            style="width: 100%;" name="btnSubmitFourth">ACCEPT</button>
                                                        </div>
                                                        <div class="col-8" style="text-align: center;">
                                                            <img src="../image/<?php print $fetchIns["ins_fourth_image"]; ?>" style="width: 80%; height: 300px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
