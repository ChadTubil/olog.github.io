                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $sqlStudents= "SELECT * FROM students_tbl WHERE stud_isdel = 0 AND stud_status ='Enrolled' ORDER BY stud_lastname ASC";
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: black;">
                                                    <?php 
                                                        $SCYI = $fetchStudents["stud_course_year_id"];
                                                        $sqlSection = "SELECT * FROM sections_tbl WHERE sec_id = '$SCYI'";
                                                        $querySection = mysqli_query($dbConString, $sqlSection);
                                                        $fetchSection = mysqli_fetch_assoc($querySection);

                                                        print $fetchSection['sec_year'];
                                                    ?>
                                                </td>
                                                <td style="color: black;"><?php print $fetchStudents["stud_status"] ?></td>
                                                <td>
                                                    <button type="button" onclick="document.location.href='users-hire.php?id=<?php print $fetchStudents['stud_id']; ?>'" class="btn btn-warning" style="height: 25px; font-size: 12px; padding: 0px 10px;"><i class="fa fa-eye"></i> VIEW</button>
                                                    <button type="button" onclick="document.location.href='users-edit.php?id=<?php print $fetchStudents['stud_id']; ?>'" class="btn btn-primary" style="height: 25px; font-size: 12px; padding: 0px 10px;"><i class="far fa-edit"></i> EDIT</button>
